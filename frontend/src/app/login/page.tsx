  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative hidden lg:block">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent to-[#0d0d0d]/40" />
      </div>
      ...
      >
        ...
        <div className="absolute right-6 top-6">
          <img
            src="/next.svg"
            alt="Logo"
            className="h-6 w-6 opacity-60 invert"
          />
        </div>
        ...
        <div className="w-full max-w-md space-y-7">
          {/* ── Heading ── */}
          <h1
            className="text-center text-3xl font-bold italic tracking-tight"
            style={{ color: "#f0f0f0", fontFamily: "var(--font-fraunces), serif" }}
          >
            Welcome to Code Bhaiya
          </h1>
